      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col gap-6">
            {[
              { num: "500+", label: isUk ? "Угод закрито" : "Deals closed" },
              { num: "9", label: isUk ? "Фахівців у команді" : "Team members" },
              { num: "5+", label: isUk ? "Років на ринку" : "Years on market" },
            ].map((stat) => (
              <div key={stat.label} className="text-center bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
                <p className="text-4xl font-bold text-gold-500">{stat.num}</p>
