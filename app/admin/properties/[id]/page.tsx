  ...
  return (
    ...
    <PropertyForm
      initialData={{
        ...
        apartmentNumber: (property as any).apartmentNumber ?? "",
        apartmentLetter: (property as any).apartmentLetter ?? "",
        pricePer: (property as any).pricePer ?? "OBJECT",
        source: (property as any).source ?? "",
        commissionAmount: (property as any).commissionAmount ?? null,
        commissionType: (property as any).commissionType ?? "FIXED",
        commissionCurrency: (property as any).commissionCurrency ?? "USD",
        internalNote: (property as any).internalNote ?? "",
